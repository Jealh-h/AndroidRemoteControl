package com.example.javaremotecontroller.view;
...
public class NumberNineGrid extends FrameLayout implements View.OnClickListener {
    public NumberNineGrid(@NonNull Context context) {
        super(context);
        initView();
    }

    public NumberNineGrid(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public NumberNineGrid(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        View numView = LayoutInflater.from(this.getContext()).inflate(R.layout.fragment_number_nine_grid, null);
